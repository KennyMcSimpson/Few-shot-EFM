...
class Gram(nn.Module):
    ...
    def load_vqgan(args):
        # print(args.gpu)
        checkpoint = torch.load(args.vqgan_model_path, map_location='cpu', weights_only=False)
...
if __name__ =='__main__':
    ...
    checkpoint = torch.load('./checkpoints/base.pth', map_location='cpu', weights_only=False)  
    model.load_state_dict(checkpoint['model'])  
