...
data_split_path = './preprocessing/SEED-IV/multi_subject_json'
...
# save_folder = "/home/bingxing2/ailab/group/ai4neuro/BrainLLM/SEED-IV/multi_subject_json"
...
tuples_list_val = []
error_list = []
subject_folder = natsorted([os.path.join(processed_data_path, f) for f in os.listdir(processed_data_path)])
